...
class ExperimentService(MessageServer):
    ...
    def __init__(self, tracker_ip: str = "127.0.0.1"):
        ...
        self.router.add_route("start_experiment_vr", self.start_experiment_vr, StartExperimentRequestVR) # works 
        self.router.add_route("test",self.test) # works 
    ...
    def start_experiment_vr(self, parameters:StartExperimentRequestVR)->StartExperimentResponse:
        print("start experiment vr received")
        print(parameters)
    ...
    def start_episode(self, parameters: StartEpisodeRequest) -> bool:
        ...
        if experiment:
            ...
            if self.tracking_service_ip:
                ...
                print("Suppressed register_consumer()")
