...
class StartExperimentRequestVR(JsonObject):
    def __init__(self, prefix: str = "", suffix: str = "", 
                 world_implementation:str = "", world_configuration:str = "",  occlusions:str = "",
                 subject_name: str = "", duration: int = 0):
        print("inside StartExperimentRequestVR")
        self.prefix = prefix
        self.suffix = suffix
    
        world = World_info()
        world.world_configuration = world_configuration
        world.world_implementation = world_implementation
        world.occlusions = occlusions 
        self.world = world
